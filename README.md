...
- `_ZO_PINYIN`
  ...
  - Enabled by default; no effect unless the path contains Chinese
    characters. Pinyin matching only applies when every keyword consists
    entirely of ASCII letters.
