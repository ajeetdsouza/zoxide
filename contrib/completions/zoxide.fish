...
complete -c zoxide -n "__fish_zoxide_needs_command" -f -a "env" -d 'Display environment variables'
...
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and not __fish_seen_subcommand_from _ZO_DATA_DIR _ZO_ECHO _ZO_EXCLUDE_DIRS _ZO_FZF_OPTS _ZO_MAXAGE _ZO_RESOLVE_SYMLINKS" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and not __fish_seen_subcommand_from _ZO_DATA_DIR _ZO_ECHO _ZO_EXCLUDE_DIRS _ZO_FZF_OPTS _ZO_MAXAGE _ZO_RESOLVE_SYMLINKS" -s V -l version -d 'Print version'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and not __fish_seen_subcommand_from _ZO_DATA_DIR _ZO_ECHO _ZO_EXCLUDE_DIRS _ZO_FZF_OPTS _ZO_MAXAGE _ZO_RESOLVE_SYMLINKS" -f -a "_ZO_DATA_DIR" -d 'Data directory'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and not __fish_seen_subcommand_from _ZO_DATA_DIR _ZO_ECHO _ZO_EXCLUDE_DIRS _ZO_FZF_OPTS _ZO_MAXAGE _ZO_RESOLVE_SYMLINKS" -f -a "_ZO_ECHO" -d 'Echo the matched directory before navigating to it'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and not __fish_seen_subcommand_from _ZO_DATA_DIR _ZO_ECHO _ZO_EXCLUDE_DIRS _ZO_FZF_OPTS _ZO_MAXAGE _ZO_RESOLVE_SYMLINKS" -f -a "_ZO_EXCLUDE_DIRS" -d 'Directories to exclude when jumping'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and not __fish_seen_subcommand_from _ZO_DATA_DIR _ZO_ECHO _ZO_EXCLUDE_DIRS _ZO_FZF_OPTS _ZO_MAXAGE _ZO_RESOLVE_SYMLINKS" -f -a "_ZO_FZF_OPTS" -d 'Custom options for fzf'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and not __fish_seen_subcommand_from _ZO_DATA_DIR _ZO_ECHO _ZO_EXCLUDE_DIRS _ZO_FZF_OPTS _ZO_MAXAGE _ZO_RESOLVE_SYMLINKS" -f -a "_ZO_MAXAGE" -d 'Maximum total age of entries'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and not __fish_seen_subcommand_from _ZO_DATA_DIR _ZO_ECHO _ZO_EXCLUDE_DIRS _ZO_FZF_OPTS _ZO_MAXAGE _ZO_RESOLVE_SYMLINKS" -f -a "_ZO_RESOLVE_SYMLINKS" -d 'Resolve symlinks before storing paths'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and __fish_seen_subcommand_from _ZO_DATA_DIR" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and __fish_seen_subcommand_from _ZO_DATA_DIR" -s V -l version -d 'Print version'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and __fish_seen_subcommand_from _ZO_ECHO" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and __fish_seen_subcommand_from _ZO_ECHO" -s V -l version -d 'Print version'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and __fish_seen_subcommand_from _ZO_EXCLUDE_DIRS" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and __fish_seen_subcommand_from _ZO_EXCLUDE_DIRS" -s V -l version -d 'Print version'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and __fish_seen_subcommand_from _ZO_FZF_OPTS" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and __fish_seen_subcommand_from _ZO_FZF_OPTS" -s V -l version -d 'Print version'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and __fish_seen_subcommand_from _ZO_MAXAGE" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and __fish_seen_subcommand_from _ZO_MAXAGE" -s V -l version -d 'Print version'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and __fish_seen_subcommand_from _ZO_RESOLVE_SYMLINKS" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand env; and __fish_seen_subcommand_from _ZO_RESOLVE_SYMLINKS" -s V -l version -d 'Print version'
